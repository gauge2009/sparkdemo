package com.alaya35.spark.stage01.core;
...
// Use 'sc' to create a Streaming context with 2 second batch interval
        ...
        //JavaRDD<String> lines = sc.textFile("hdfs://spark:9000/spark.txt");
        JavaRDD<String> lines = sc.textFile("hdfs://spark:8020/spark.txt");
